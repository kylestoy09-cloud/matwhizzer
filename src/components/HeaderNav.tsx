...
export function HeaderNav() {
  ...
  const borderClass   = isBoys ? 'border-blue-900' : 'border-purple-800'
  ...
  return (
    <>
      <header className={`${bgClass} ${textClass} px-6 py-6 shadow-md flex items-center`}>
      ...
      {/* Thick colored border under header */}
      <div className={`h-1.5 ${borderClass} bg-current`} />
    </>
  )
}
