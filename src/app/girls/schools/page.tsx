...
export default async function GirlsSchoolsPage({
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-rose-900">Girls School Directory</h1>
        <p className="text-slate-500 text-sm mt-1">
          {all.length} schools · NJSIAA 2024–25 girls postseason
        </p>
      </div>
      ...
      <form method="GET" className="mb-6">
        <div className="flex gap-2">
          ...
          <button
            type="submit"
            className="bg-rose-900 text-white px-5 py-2.5 rounded-lg font-medium
