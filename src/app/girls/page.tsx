      ...
      {showLeaderboards && (
        <div className="space-y-10 border-t border-slate-200 pt-10 mb-10">
          ...
          {topTeamScores.length > 0 && (
            <section>
              <h2 className="text-lg font-bold text-rose-900 mb-3">Postseason Point Leaders</h2>
                    ...
                    {topTeamScores.map((r, i) => (
                      <tr key={r.school} className={i % 2 === 0 ? 'bg-white' : 'bg-slate-50/60'}>
                        ...
                        <td className="px-3 py-2">
                          <Link href={`/girls/schools/${encodeURIComponent(r.school)}`} className="font-medium text-slate-800 hover:underline">
