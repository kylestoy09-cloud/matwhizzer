...
export default async function GirlsStatePage() {
  const [placementsRes, matTimeRes, fastPinRes, fastTfRes, bonusPctRes, teamScoreRes] =
    await Promise.all([
      supabase.rpc('state_placements',  { p_gender: 'F' }),
      supabase.rpc('state_mat_time',    { p_gender: 'F' }),
      supabase.rpc('state_fastest_pin', { p_gender: 'F' }),
      supabase.rpc('state_fastest_tf',  { p_gender: 'F' }),
      supabase.rpc('state_bonus_pct',   { p_gender: 'F' }),
      supabase.rpc('state_team_score',  { p_gender: 'F' }),
    ])
