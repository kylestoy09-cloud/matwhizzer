  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <section>
        <Link
          href="/boys/state"
          className="flex items-center justify-between px-5 py-4 rounded-xl border border-slate-200 bg-white shadow-sm hover:bg-slate-50 hover:border-slate-300 transition-colors group"
        >
          <div>
          ...
          <span className="text-slate-400 text-xl ml-4 group-hover:text-slate-600 transition-colors">→</span>
        </Link>
      </section>
    </div>
  )
