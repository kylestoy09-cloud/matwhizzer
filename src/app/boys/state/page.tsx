...
export default async function StateBoysPage() {
  const [placementsRes, matTimeRes, fastPinRes, fastTfRes, bonusPctRes, teamScoreRes] =
    await Promise.all([
      supabase.rpc('state_placements',  { p_gender: 'M' }),
      supabase.rpc('state_mat_time',    { p_gender: 'M' }),
      supabase.rpc('state_fastest_pin', { p_gender: 'M' }),
      supabase.rpc('state_fastest_tf',  { p_gender: 'M' }),
      supabase.rpc('state_bonus_pct',   { p_gender: 'M' }),
      supabase.rpc('state_team_score',  { p_gender: 'M' }),
    ])
